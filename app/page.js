...
export default function Home() {
  return (
    <section className="flex flex-col items-center w-screen h-screen  px-20 pt-72 pb-36 md:pb-10 text-xl bg-black text-center white  max-md:pt-24">
      <article className="flex flex-col items-center  bg-black  text-white">
        <section className="self-stretch mt-1.5 tracking-widest leading-7 w-screen bg-black max-md:max-w-full  ">
